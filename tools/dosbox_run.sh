#!/usr/bin/env bash
# 一行指令啟動 Demon's Winter 的 DOSBox 參考環境（headless，全程 docker）。
#
# 用法：
...
#
# 遊戲資料：第一次跑會自動從 workplace/orig/demwin/ 複製一份可寫副本到
