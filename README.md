...
| **事件**　踩到特殊格觸發敘述，368 條資料文字 100% 中文化 | **戰鬥**　行動點、法術、地形與視線遮蔽，怪物 AI 照原版 |
...
結局序列已照原版接上（含「成為不朽 or 回歸凡人」的抉擇與依職業不同的隊員下場），
但三場夢與艾瑞戈爾那兩段還沒接；這幾段的英文原文也還沒翻。
...
| 遊戲內文字中文化 | 資料文字 **368/368（100%）**；介面文案機制已建、分批遷移中 |
| 完整試玩驗收 | **未做** —— 見上方「還沒做到的」|
