...
| M5 城鎮與經濟 | 🔶 價格體系 + 城鎮畫面完成：經濟係數 E 的八個公式、兩個不看 E 的例外、治療所四項服務與優先序、學院費用表、神殿捐獻與祈禱、市集議價狀態機；**城鎮表已確認就是 `TOWN<n>.DAT`**（E@0x1ed、船價@0x1f5，兩個獨立佐證），七種設施畫面可操作、市集可議價。**進出城流程卡在「世界座標 → 城鎮編號」未解**，viewer 暫用選單進城 |
