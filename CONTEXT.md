...
| Go 引擎本體 | **M1–M5 完成**（見下），**開場標題畫面已接上**。原版版面刻意不復刻（中文需要 640×400）；**原版怪物 AI 的決策樹已解**（`FUN_138d_03f5`，見 `docs/spec/02-combat.md`），目標記憶已實作，噴吐與 AI 選法術兩支未做 |
