...
- [ ] **RNG 精確公式**(框架已知,除法輔助 `FUN_3016_0068` 未解 → 頭號待辦)
...
| **RNG 精確公式未完全解出** | 戰鬥無法逐位元對拍原版 | 已知框架(DOS 時鐘 seed + 32-bit 同餘乘數 125 + 軟體浮點換算),但除法輔助函式 `FUN_3016_0068` 未解。**這是對拍前必須突破的點**,見 `docs/re/06` §9 |
